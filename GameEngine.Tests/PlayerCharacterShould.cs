...
namespace GameEngine.Tests
{
    public class PlayerCharacterShould: IDisposable
    {
        ...
        public PlayerCharacterShould(ITestOutputHelper outputHelper)
        {
            ...
            _outputHelper.WriteLine("Creating new PlayerCharacter");
            _sut = new PlayerCharacter();
        }

        public void Dispose()
        {
            _outputHelper.WriteLine($"Disposing PlayerCharacter {_sut.FullName}");
        ...
        {
            Assert.Contains(_sut.Weapons, wepaon => wepaon.Contains("Sword"));
        }
